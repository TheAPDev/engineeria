    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center py-4 px-2 sm:px-6 sm:py-8">
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="flex flex-col gap-6 mb-12">
          {internships.map((i) => (
            <div key={i.id} className="bg-gray-900 border border-red-600/20 rounded-2xl p-5 shadow-lg card-hover flex flex-col gap-3">
              ...
              <a href={i.link} className="w-full text-center py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl font-semibold transition-all duration-200 text-lg shadow-md active:scale-95">Apply</a>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col gap-6">
          {hackathons.map((h) => (
            <div key={h.id} className="bg-gray-900 border border-red-600/20 rounded-2xl p-5 shadow-lg card-hover flex flex-col gap-3">
              ...
              <a href={h.link} className="w-full text-center py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl font-semibold transition-all duration-200 text-lg shadow-md active:scale-95">Register</a>
            </div>
          ))}
        </div>
      </div>
